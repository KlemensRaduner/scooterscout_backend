package ch.tbz.scooterscout.security;

import ch.tbz.scooterscout.core.user.UserService;
import ch.tbz.scooterscout.core.user.mapper.UserMapper;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		//configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080","http://localhost:8084"));
